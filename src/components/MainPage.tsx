      ...
      {!token && <section>
        <Container sx={{ py: 8 }}>
          <section className="py-16 px-6 text-center bg-gray-50">
            ...
            <Button onClick={handleLogin} className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full transition shadow-lg">
        ...
        <Container maxWidth="md" sx={{ py: 8 }}>
          ...
          <Paper elevation={0} sx={{ mt: 6, p: 4, textAlign: 'center', bgcolor: 'error.light', color: 'error.contrastText', borderRadius: 4 }}>
            ...
            <Button onClick={handleLogin} variant="contained" color="warning" size="large" sx={{ fontWeight: 'bold' }}>
              Book a Free Trial
            </Button>
          </Paper>
        </Container>
